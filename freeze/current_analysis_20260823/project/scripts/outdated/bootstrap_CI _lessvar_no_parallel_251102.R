...
set.seed(123)
# 或者批量运行所有组合（带进度）
run_all_bootstraps <- function(test_sim_pred_filename = "results/simulate_result_pred_250919.RData",
                               bootstrap_size = 50,
                               iteration = 1000) {
...
#### 11.2 parallel with estimated time ####
# pre-calculate W
...
# 主程序：带总体进度的批量运行
# ============================================================================
run_all_parallel_bootstrap <- function(test_sim_pred_filename = "results/simulate_result_pred_250919.RData",
                                       bootstrap_size = 300,
                                       iteration = 500,
                                       n_cores = 3,
