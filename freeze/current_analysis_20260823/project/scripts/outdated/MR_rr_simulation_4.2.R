...
parameters = .get_parameters(1,px=24)
...
save(simulate_result, file = "results/simulate_result_250405.RData")
                         ...
                         weight_to_plot)
{
  ...
  ggplot2::ggsave(sprintf("results/hmap_4.5_with_MrDAG/bias_hm_weight_%s.png",weight_to_plot), plot = combined_hm_bias, width = 12, height = 4)
  ggplot2::ggsave(sprintf("results/hmap_4.5_with_MrDAG/sd_hm_weight_%s.png",weight_to_plot), plot = combined_hm_sd, width = 12, height = 4)
...
# 4.539335e-11 3.341317e-12 1.110624e-15
c=10
