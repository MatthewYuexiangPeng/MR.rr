...
save_sim_pred_filename = "results/simulate_result_pred_250930.RData"
...
save(sparse_results, file = "results/simulate_result_pred_sparse_1000_251107.RData")
...
plot_simulation_result_pred <- function(sim_result, 
  ...
  p <- ggplot(df_long, aes(x = Estimator)) +
    plot_layers +
    facet_wrap(~ Row, ncol = 4, labeller = labeller(Row = out_name)) +
