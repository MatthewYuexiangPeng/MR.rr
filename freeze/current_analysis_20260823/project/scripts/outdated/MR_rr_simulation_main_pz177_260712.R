...
# C = gen_C_sparseB(px, py, r, lip_data_real)
...
# Note: in the code, index 1: me=2.5, effect=0.25, index 2: me=2.5, effect=1, index 3: me=1,   effect=0.25, index 4: me=1,   effect=1. But in the paper, index 2 and 3 should switch in order to make SIV increasing.
# we have reordered the table output to maktch the order needed in paper
...
# setting 1: 4.629493e-09 1.309088e-09 4.016064e-10 5.741664e-11
# setting 2: 4.624812e-09 1.263033e-09 3.890519e-10 5.667788e-11

# updated 260716
# setting 1: 1.150532e-10 2.555140e-12 1.677839e-12 3.116034e-15
# setting 2: 2.244902e-10 3.581315e-11 2.722694e-11 8.459856e-12
...
# setting 1:
save_sim_pred_filename = "results/simulate_result_pred_260716_regularC.RData"

# setting 2:
# save_sim_pred_filename = "results/simulate_result_pred_260714_sparseC.RData"
...
# load("results/simulate_result_pred_260712_177.RData")

# # test
# load("results/simulate_result_pred_260416_1000.RData")
...
save(rank_results_all, file = "results/simulate_result_rank_260716_regularC.RData")
# save(rank_results_all, file = "results/simulate_result_rank_260714_sparseC.RData")

# load("results/simulate_result_rank_260712_M0_177.RData")
...
save(eta_selection_result, file = "results/eta_selection_result_260716_sparseC.RData") 
...
save(sparse_results, file = "results/simulate_result_pred_sparse_260712_177.RData") 
load("results/simulate_result_pred_sparse_260712_177.RData")
