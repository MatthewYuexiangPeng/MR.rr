...
estimate_C <- function(gamma_exp_j,se_exp_j,gamma_out_j,se_out_j,cor_exp,cor_out){
  ...
  r_RR = rank_test_M0(W, gamma_out_j, gamma_exp_j, Sigma_X, print = TRUE)
...
draw_multiple_heatmaps(
  ...
  filename = "results/Causal_C_estimation_hm_260603.png",
  ncol = 3
)
...
save(bootstrap_C_list, file = "bootstrap_C_list_1000_260603.RData")
# load bootstrap_C_list
load("bootstrap_C_list_1000_260603.RData")
...
plot_realdata_halfeye(
  ...
  ylim = c(-0.5, 0.5),
  save_path = "results/real_data_CI_halfeye_260603_with_sparse.png"
)
