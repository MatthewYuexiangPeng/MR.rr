...
# }
# 
# eta_path_df <- bind_rows(eta_path_list)
# 
# # plot
# # Custom eta labels
# eta_label <- function(x) {
...
#   )
# 
# eta_selection_plot <- p_eta_obj / p_eta_sparse
# 
# eta_selection_plot
# 
# ggsave(
#   filename = "results/real_data_sparse_eta_selection_260729_rank1.png",
#   plot = eta_selection_plot,
#   width = 9,
#   height = 8,
#   units = "in",
#   dpi = 300,
...
out_file <- function(stem, ext) {
  file.path("results", paste0(stem, "_260722_rank2_", eta_tag, ext))
}


# selected_rank <- 1

# sensitivity test: rank = 2
selected_rank = 2
...
draw_multiple_heatmaps(
  ...
  titles = c("IVW","SRIVW","Naive MR-rr","MR-rr","Reg. MR-rr","Sparse MR-rr","MrDAG"),
  filename = out_file("Causal_C_estimation_hm_postselection", ".png"),
  ncol = 3
)
...
draw_multiple_heatmaps(
  ...
  col_labels = exp_name,
  filename = out_file("B_loading_heatmaps", ".png"),
  ncol = 1,
  cellwidth = 30,
  cellheight = 25
)
