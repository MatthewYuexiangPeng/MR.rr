...
for (i in seq_along(me_weight_list)) {
  for (j in seq_along(effect_weight_list)) {
    ...
    # 每完成一个任务就保存
    save(CI_cov_result_mr_only, file = "results/CI_coverage_parallel_temp_mr_only_10.26.RData")
...
# 最终保存
save(CI_cov_result_mr_only, file = "results/CI_coverage_MR_IVW_300_500_10.26.RData")
